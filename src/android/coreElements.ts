...
const CORE_VIEW_IMPORTS = `import android.content.Context
import android.view.View
...
export function getScreenElementSource(packageName: string): string {
  return `package ${packageName}.core
${CORE_VIEW_IMPORTS}
...
export function getSafeAreaElementSource(packageName: string): string {
  return `package ${packageName}.core
${CORE_VIEW_IMPORTS}
...
export function getAvoidKeyboardElementSource(packageName: string): string {
  return `package ${packageName}.core
${CORE_VIEW_IMPORTS}
...
export function getAppBarElementSource(packageName: string): string {
  return `package ${packageName}.core
${CORE_VIEW_IMPORTS}
